from datasets_run2_1 import datasets_dict as ds_dy
ds_dy = ds_dy['5 seeds']
from datasets_run2_tt2l2nu import datasets as ds_tt2l2nu
from datasets_run2_ttsemilept import datasets as ds_ttsemilept
from datasets_run2_qcd import datasets as ds_qcd
